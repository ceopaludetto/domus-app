...
export const { Types, Creators } = createActions({
    requestApartamento: ['APTO_INT_NUM', 'APTO_INT_AND', 'BLO_INT_ID'],
    requestApartamentoGen: ['BLO_QTD', 'AND_QTD', 'APTO_QTD', 'BLOCOS'],
    requestApartamentoEdit: ['APTO_INT_NUM', 'APTO_INT_AND', 'BLO_INT_ID', 'APTO_INT_ID'],
    requestApartamentoDelete: ['APARTAMENTOS'],
